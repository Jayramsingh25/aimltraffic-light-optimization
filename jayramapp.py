...
peak_hour = st.number_input("Peak Hour (0 or 1)")

if st.button("Predict"):

    data = np.array([[traffic_density, vehicle_count, average_speed, lane_count, peak_hour]])
    ...
    st.success(f"Predicted Green Signal Time: {round(prediction[0], 2)} seconds")
